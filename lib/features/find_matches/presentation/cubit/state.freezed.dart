...
mixin _$FindMatchesState {
 ...
 FindMatchesStatus get status; List<Word> get leftWords; List<Word> get rightWords; Word? get left; Word? get right; int get correctCount; int get totalCount; bool get correct; bool get answered; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(leftWords),const DeepCollectionEquality().hash(rightWords),const DeepCollectionEquality().hash(left),const DeepCollectionEquality().hash(right),correctCount,totalCount,correct,answered,errorMessage);

@override
String toString() {
  return 'FindMatchesState(status: $status, leftWords: $leftWords, rightWords: $rightWords, left: $left, right: $right, correctCount: $correctCount, totalCount: $totalCount, correct: $correct, answered: $answered, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 FindMatchesStatus status, List<Word> leftWords, List<Word> rightWords, Word? left, Word? right, int correctCount, int totalCount, bool correct, bool answered, String? errorMessage
});
...
/// Create a copy of FindMatchesState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? leftWords = null,Object? rightWords = null,Object? left = freezed,Object? right = freezed,Object? correctCount = null,Object? totalCount = null,Object? correct = null,Object? answered = null,Object? errorMessage = freezed,}) {
...
as Word?,correctCount: null == correctCount ? _self.correctCount : correctCount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( FindMatchesStatus status,  List<Word> leftWords,  List<Word> rightWords,  Word? left,  Word? right,  int correctCount,  int totalCount,  bool correct,  bool answered,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FindMatchesState() when $default != null:
return $default(_that.status,_that.leftWords,_that.rightWords,_that.left,_that.right,_that.correctCount,_that.totalCount,_that.correct,_that.answered,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( FindMatchesStatus status,  List<Word> leftWords,  List<Word> rightWords,  Word? left,  Word? right,  int correctCount,  int totalCount,  bool correct,  bool answered,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _FindMatchesState():
return $default(_that.status,_that.leftWords,_that.rightWords,_that.left,_that.right,_that.correctCount,_that.totalCount,_that.correct,_that.answered,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( FindMatchesStatus status,  List<Word> leftWords,  List<Word> rightWords,  Word? left,  Word? right,  int correctCount,  int totalCount,  bool correct,  bool answered,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _FindMatchesState() when $default != null:
return $default(_that.status,_that.leftWords,_that.rightWords,_that.left,_that.right,_that.correctCount,_that.totalCount,_that.correct,_that.answered,_that.errorMessage);case _:
  return null;
...
class _FindMatchesState implements FindMatchesState {
  const _FindMatchesState({this.status = FindMatchesStatus.initial, final  List<Word> leftWords = const [], final  List<Word> rightWords = const [], this.left, this.right, this.correctCount = 0, this.totalCount = 0, this.correct = false, this.answered = false, this.errorMessage}): _leftWords = leftWords,_rightWords = rightWords;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_leftWords),const DeepCollectionEquality().hash(_rightWords),const DeepCollectionEquality().hash(left),const DeepCollectionEquality().hash(right),correctCount,totalCount,correct,answered,errorMessage);
...
/// Create a copy of FindMatchesState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? leftWords = null,Object? rightWords = null,Object? left = freezed,Object? right = freezed,Object? correctCount = null,Object? totalCount = null,Object? correct = null,Object? answered = null,Object? errorMessage = freezed,}) {
